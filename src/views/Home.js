        ...
        <main className="home-main">
          <section className="home-section1-welcome">
            ...
            <div className="home-info-text">
              ...
              <p>
                ...
                collection where we all together can add new informations, so
                this will grow for more visibility! For that every list has a
                form somewhere where you can post your own feminist group,
                favorite pioneer or event! Please do so!
              </p>
            </div>
          </section>
          <section className="home-section2-all-sub-views">
            ...
            <div className="home-info-card-sub-views">
              ...
              <p>
                "pioneers" shows you a list of Women Pioneers in Computer
            ...
            <div className="home-info-card-sub-views">
              ...
              <p>
                ...
                perspectives on/in Programming for your widening your
                perspective and also networking with other interested people
              </p>
